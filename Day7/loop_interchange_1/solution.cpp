...
void multiply(Matrix &result, const Matrix &a, const Matrix &b) {
  ...
  // The order of loops is i, j, k. This can lead to poor cache performance 
  // because the innermost loop accesses elements of the b matrix in a non sequential manner,
  //  which can cause cache misses.
  ...
  // Optimized multiplication with loop interchange :
  // The order of loops is changed to improve cache performance. 
  // The innermost loop now iterates over 'j', which allows for better spatial locality 
